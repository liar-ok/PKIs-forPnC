package kr.ac.hmcl.mju.CpsSubCA2;
...
class ServerThread extends Thread {
	TCPServer server;
	SecUtils sUtils;
	String cpsSubCa2Dn = "C=KR, O=MJU, OU=HMCL, CN=MJU_CPS_SubCA2, DC=V2G";
...
public class Main {
	...
	public static void main(String[] args) {
		...
		String cpsSubCa2Dn = "C=KR, O=MJU, OU=HMCL, CN=MJU_CPS_SubCA2, DC=V2G";
		String cpsSub2PrivateFileName = "cps_sub1_private_" + sub2CertCount + ".pem";

		

		while (mainFlag == 1) {
			System.out.println("cps SubCA2");
				...
				while (isConnected) {
					...
					if (getData != null) {
						...
						if (type.equals("ResWithCert")) {
							...
							client.clientStop();
							isConnected = false;
							System.out.println("finish connection with CPS SubCA1");
						}
					}
				}
			}
