package kr.ac.hmcl.mju.Cps_2_SubCA1;
...
class ServerThread extends Thread {
	TCPServer server;
	SecUtils sUtils;
	String cpsSubCa1Dn = "C=KR, O=MJU, OU=HMCL, CN=MJU_CPS-2_SubCA1, DC=V2G";
...
public class Main {
	...
	public static void main(String[] args) {
		...
		String cpsSubCa1Dn = "C=KR, O=MJU, OU=HMCL, CN=MJU_CPS-2_SubCA1, DC=V2G";
		String cpsSub1PrivateFileName = "cps-2_sub1_private_" + sub1CertCount + ".pem";


		while (mainFlag == 1) {
			System.out.println("cps-2 SubCA1");
